 ...
 * http://p0l0.binware.org/index.php/2012/02/18/Laminas-framework-2-authentication-acl-using-eventmanager/
 */
...
/**
 * @uses Laminas\Acl\Acl
 * @uses Laminas\Acl\Role\GenericRole
 * @uses Laminas\Acl\Resource\GenericResource
 */
